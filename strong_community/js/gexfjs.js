                ...
                if (isJson) {
                    ...
                    $(_edges).each(function () {
                        var _e = $(this),
                            ...
                            _w = _e.find('attvalue[for="shared viewers"]').attr('value') || _e.attr('shared viewers'),
    ...
    function traceMap() {
        ...
        if (!GexfJS.params.isMoving && (GexfJS.params.showEdges || _centralNode != -1)) {
            ...
            for (var i in GexfJS.graph.edgeList) {
       		 ...
       		 } else{ GexfJS.ctxGraphe.strokeStyle = (_d.Ct);}
